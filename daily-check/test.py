...
def process_fng(raw_data: dict) -> pd.DataFrame:
    ...
    try:
        ...
        print(fng_df[['datetime', 'fng_value']].head(10))
        ...
        print("\nAfter filtering for 00:00:00:")
        print(fng_df[['datetime', 'fng_value']])
        ...
        fng_df['fng_value'] = fng_df['fng_value'].round(0).astype(int)
